...
EvosAttacks::
	...
	learnset 28, GROWTH
	learnset 32, GIGA_DRAIN
	learnset 40, ANCIENTPOWER ; Worry Seed → event move
	learnset 48, HEALINGLIGHT ; Synthesis → similar move
	learnset 56, SLUDGE_BOMB ; Seed Bomb →  TM move
	...
	learnset 16, DRAGON_BREATH ; Dragon Rage → GSC TM move
	learnset 20, SCARY_FACE
	learnset 24, FLAME_CHARGE ; Fire Fang → TM move
	learnset 28, SLASH ; Flame Burst → Slash
	learnset 32, DRAGON_CLAW ; Slash → TM move
	learnset 36, FLAMETHROWER
	learnset 40, FIRE_SPIN
	learnset 44, CRUNCH
	learnset 48, FLARE_BLITZ ; Sw/Sh move
	...
	learnset 26, FLAME_CHARGE ; Fire Fang → TM move
	learnset 31, SLASH ; Flame Burst → Slash
	learnset 36, DRAGON_CLAW ; Slash → TM move
	learnset 41, FLAMETHROWER
	learnset 46, FIRE_SPIN
	learnset 51, CRUNCH
	...
	learnset 48, FIRE_SPIN
	learnset 54, CRUNCH
	learnset 60, FLARE_BLITZ ; Sw/Sh move
	learnset 66, HURRICANE ; Sw/Sh move
	...
	evos_attacks Butterfree ; based on Sw/Sh learnset
	learnset 1, TACKLE
	learnset 1, STRING_SHOT
	learnset 1, BUG_BITE
	...
	learnset 12, SLEEP_POWDER ; Psybeam → Sleep Powder
	learnset 16, PSYBEAM ; Silver Wind → Psybeam
	learnset 20, SAFEGUARD ; Whirlwind → Safeguard
	learnset 24, AIR_SLASH
	learnset 28, HYPNOSIS ; Safeguard → new move
	learnset 32, BUG_BUZZ
	learnset 36, AGILITY ; Tailwind → new move
	learnset 40, HEALINGLIGHT ; Rage Powder → new move
	learnset 44, CALM_MIND ; Quiver Dance → TM move 
	learnset 48, HURRICANE ; Sw/Sh move
	...
	learnset 28, FEINT_ATTACK ; Assurance → similar move
	learnset 32, PIN_MISSILE
	learnset 36, POISON_JAB
	learnset 40, AGILITY
	learnset 44, SWORDS_DANCE ; Endeavor → TM move
	learnset 48, GUNK_SHOT ; Fell Stinger → new move

	evos_attacks Pidgey
	evo_data EVOLVE_LEVEL, 18, PIDGEOTTO
	learnset 1, TACKLE
	learnset 5, MUD_SLAP ; Sand Attack → GSC TM move
	learnset 9, GUST
	learnset 13, QUICK_ATTACK
	learnset 17, WING_ATTACK ; Whirlwind → Wing Attack
	learnset 21, CHARM ; Twister → egg move
	learnset 25, SWIFT ; Feather Dance → TM move
	learnset 29, AGILITY
	learnset 33, DRILL_PECK ; Wing Attack → new move
	learnset 37, ROOST
	learnset 41, SLASH ; Tailwind → new move
	...
	learnset 32, AGILITY
	learnset 37, DRILL_PECK ; Wing Attack → new move
	learnset 42, ROOST
	learnset 47, SLASH ; Tailwind → new move
	...
	learnset 27, SWIFT ; Feather Dance → TM move
	learnset 32, AGILITY
	learnset 38, DRILL_PECK ; Wing Attack → new move
	learnset 44, ROOST
	learnset 50, SLASH ; Tailwind → new move
	...
	learnset 33, POISON_JAB ; Mud Bomb → TM move
	...
	learnset 12, QUICK_ATTACK ; Electro Ball → Quick Attack
	learnset 16, SPARK ; Feint → Spark
	learnset 20, CHARM ; Spark → Pichu move
	learnset 24, AGILITY
	learnset 28, IRON_TAIL
	learnset 32, THUNDERBOLT ; Discharge → Thunderbolt
	learnset 36, EXTRASENSORY ; Thunderbolt → new move
	...
	learnset 1, EXTRASENSORY ; new move
	...
	learnset 6, RAPID_SPIN ; Sand Attack → Rapid Spin
	learnset 9, ROLLOUT
	learnset 12, PIN_MISSILE ; Fury Cutter → new move
	learnset 15, MAGNITUDE ; Rapid Spin → SMUSUM level-up move
	...
	learnset 1, SCRATCH
	learnset 1, DEFENSE_CURL
	learnset 1, FOCUS_ENERGY ; Bide → new move
	learnset 3, ICY_WIND ; Powder Snow → similar move
	learnset 6, RAPID_SPIN ; Powder Snow → Rapid Spin
	learnset 9, ROLLOUT
	learnset 12, PIN_MISSILE ; Fury Cutter → new move
	learnset 15, ICE_BEAM ; Rapid Spin → TM move
	learnset 18, METAL_CLAW
	learnset 21, SWIFT
	learnset 24, FURY_STRIKES ; Fury Swipes → similar move
	learnset 27, ROLLOUT ; Iron Defense → TM move
	learnset 30, SLASH
	...
	learnset 18, BULLDOZE
	learnset 21, SWIFT
	learnset 25, FURY_STRIKES ; Fury Swipes → similar move
	learnset 29, SUPER_FANG ; Sand Tomb → HGSS tutor move
	learnset 33, SLASH
	learnset 37, DIG
	...
	learnset 16, DRAINING_KISS ; Life Dew → Sw/Sh move
	learnset 20, MINIMIZE ; Metronome → Minimise (I shall not give in to the fiendish ways of the Americans! /j)
	learnset 24, HEALINGLIGHT ; Moonlight → similar move
	learnset 28, METRONOME ; Gravity → Metronome
	learnset 32, EXTRASENSORY ; Meteor Mash → new move
	learnset 36, DEFENSE_CURL ; Follow Me → Defense Curl
	learnset 40, ANCIENTPOWER ; Cosmic Power → similar move
	learnset 44, MOONBLAST
	learnset 48, HEAL_BELL ; Healing Wish → HGSS tutor move
	...
	learnset 48, MOONBLAST
	learnset 64, HEAL_BELL
	...
	learnset 1, DEFENSE_CURL
	learnset 4, DISABLE
	learnset 8, DIZZY_PUNCH ; Covet → Crystal unique move
	learnset 12, DOUBLE_SLAP
	learnset 16, DISARM_VOICE
	learnset 20, REST
	learnset 24, BODY_SLAM
	learnset 28, ROLLOUT ; Mimic → Rollout
	learnset 32, GYRO_BALL
	learnset 36, HYPER_VOICE
	learnset 40, PLAY_ROUGH
	learnset 44, DOUBLE_EDGE
	learnset 48, HEAL_BELL ; HGSS tutor move
	...
	learnset 1, BODY_SLAM ; evolution move
	learnset 1, SING
	learnset 1, DEFENSE_CURL
	learnset 1, DISABLE
	learnset 1, DOUBLE_SLAP
	learnset 48, DOUBLE_EDGE
	learnset 56, HEAL_BELL
	...
	learnset 19, SWIFT ; Air Cutter → Swift
	learnset 22, SUPER_FANG ; Swift → HGSS tutor move
	learnset 25, VENOSHOCK ; Poison Fang → Venoshock
	learnset 28, MEAN_LOOK
	learnset 31, ACROBATICS
	learnset 34, HAZE
	learnset 37, POISON_JAB ; Venoshock → new move
	learnset 40, AIR_SLASH
	...
	learnset 19, SWIFT ; Air Cutter → Swift
	learnset 22, SUPER_FANG ; Swift → HGSS tutor move
	learnset 26, VENOSHOCK ; Poison Fang → Venoshock
	learnset 30, MEAN_LOOK
	learnset 34, ACROBATICS
	learnset 38, HAZE
	learnset 42, VENOSHOCK
	learnset 46, AIR_SLASH
	learnset 50, PURSUIT ; Quick Guard → egg move
	...
	learnset 17, MEGA_DRAIN
	learnset 21, HEX ; Lucky Chant → new move
	learnset 25, HEALINGLIGHT ; Moonlight → similar move
	learnset 29, GIGA_DRAIN
	learnset 33, TOXIC
	learnset 37, SHADOW_BALL ; Natural Gift → new move
	learnset 41, MOONBLAST
	learnset 45, GROWTH ; Grassy Terrain → GSC move
	learnset 49, PETAL_DANCE
	...
	learnset 33, GIGA_DRAIN
	learnset 39, TOXIC
	learnset 45, SHADOW_BALL ; Natural Gift → new move
	learnset 51, MOONBLAST
	learnset 57, GROWTH ; Grassy Terrain → Crystal move
	learnset 63, PETAL_DANCE
	...
	learnset 51, MOONBLAST ; Petal Blizzard → Gloom move
	learnset 57, PETAL_DANCE
	learnset 63, SOLAR_BEAM
	...
	learnset 12, POISONPOWDER
	learnset 16, PSYBEAM
	learnset 20, BUG_BITE ; Stun Spore → HGSS tutor move
	learnset 24, STUN_SPORE ; Signal Beam → Stun Spore
	learnset 28, SLEEP_POWDER
	learnset 32, LEECH_LIFE
	learnset 36, ZEN_HEADBUTT
	learnset 40, SLUDGE_BOMB ; Poison Fang → TM move
	...
	learnset 28, SLEEP_POWDER
	learnset 33, GUST
	learnset 38, LEECH_LIFE
	learnset 43, ZEN_HEADBUTT
	learnset 48, SLUDGE_BOMB ; Poison Fang → TM move
	learnset 53, PSYCHIC_M
	learnset 58, BUG_BUZZ
	learnset 63, CALM_MIND ; Quiver Dance → similar move
	...
	learnset 1, GROWL
	learnset 4, FEINT_ATTACK ; Feint → SMUSUM level up move
	learnset 8, SCRATCH
	learnset 12, FURY_STRIKES ; Fury Swipes → similar move
	learnset 16, BITE
	learnset 20, THIEF ; Taunt → TM move
	learnset 24, PURSUIT ; Assurance → egg move
	learnset 28, PAY_DAY
	learnset 32, SCREECH
	learnset 36, SLASH
	learnset 40, NASTY_PLOT
	learnset 44, CHARM ; Captivate → egg move
	...
	learnset 20, HONE_CLAWS
	learnset 24, PURSUIT ; Taunt → new move
	learnset 28, PAY_DAY
	learnset 32, SCREECH
	learnset 36, SLASH
	...
	learnset 1, BUBBLE_BEAM ; RBY TM move
	learnset 1, PLAY_ROUGH
	learnset 1, TRICK ; Switcheroo → similar move
	learnset 1, SLASH
	learnset 1, SWIFT ; evolution move
	learnset 1, ASTONISH ; Fake Out → new move
	learnset 1, GROWL
	...
	learnset 12, FURY_STRIKES ; Fury Swipes → similar move
	learnset 15, WATER_PULSE
	learnset 18, DISABLE
	learnset 21, ZEN_HEADBUTT
	learnset 24, SCREECH
	learnset 27, AQUA_TAIL
	learnset 30, RAIN_DANCE ; Soak → TM move
	learnset 33, PSYBEAM ; Psych Up → egg move
	learnset 36, AMNESIA
	learnset 39, HYDRO_PUMP
	learnset 42, NASTY_PLOT ; Wonder Room → SV TM move
	learnset 45, PSYCHIC_M ; TM move
	...
	learnset 1, LEER
	learnset 1, FOCUS_ENERGY
	learnset 4, FURY_STRIKES ; Fury Swipes → similar move
	learnset 7, KARATE_CHOP
	learnset 11, ASTONISH
	learnset 14, SEISMIC_TOSS
	learnset 18, SWAGGER
	learnset 21, CROSS_CHOP
	learnset 25, REVERSAL ; Assurance → egg move
	learnset 28, SHADOW_CLAW ; Punishment → new move
	learnset 32, THRASH
	learnset 35, CLOSE_COMBAT
	learnset 39, SCREECH
	learnset 42, GUNK_SHOT ; Stomping Tantrum → HGSS tutor move
	learnset 46, OUTRAGE
	...
	learnset 28, SHADOW_CLAW ; Punishment → new move
	learnset 34, THRASH
	learnset 40, CLOSE_COMBAT
	learnset 46, SCREECH
	learnset 52, GUNK_SHOT ; Stomping Tantrum → HGSS tutor move
	learnset 58, OUTRAGE
	...
	learnset 34, FLAMETHROWER
	learnset 39, CRUNCH
	learnset 41, ANCIENTPOWER ; Heat Wave → new move
	learnset 43, OUTRAGE
	learnset 45, PLAY_ROUGH ; Flare Blitz → LGPE move
	learnset 49, FLARE_BLITZ
	...
	learnset 4, DOUBLE_SLAP
	learnset 7, MUD_SLAP
	learnset 10, AQUA_JET ; Bubble → new move
	learnset 13, SWEET_KISS ; event move
	learnset 16, RAIN_DANCE
	learnset 19, BODY_SLAM
	learnset 22, BUBBLE_BEAM
	learnset 25, AQUA_TAIL ; Mud Shot → new move
	learnset 28, BELLY_DRUM
	learnset 31, LOW_KICK ; Wake-Up Slap → Low Kick
	learnset 34, HYDRO_PUMP
	learnset 37, EARTH_POWER ; Mud Bomb → similar move
	...
	learnset 37, LOW_KICK ; Wake-Up Slap → Low Kick
	learnset 43, HYDRO_PUMP
	learnset 49, EARTH_POWER ; Mud Bomb → similar move
	...
	learnset 31, DYNAMICPUNCH
	learnset 43, FORESIGHT ; Mind Reader → similar move
	learnset 55, CROSS_CHOP ; Circle Throw → similar move
	...
	evo_data EVOLVE_TRADE, TWISTEDSPOON, ALAKAZAM
	learnset 1, TELEPORT
...
if DEF(FAITHFUL)
	...
	evo_data EVOLVE_LEVEL, 25, MACHOKE
endc
	learnset 1, LOW_KICK
	learnset 1, LEER
	learnset 4, FOCUS_ENERGY
	learnset 7, KARATE_CHOP
	learnset 10, FORESIGHT
	learnset 13, BULLET_PUNCH ; Low Sweep → egg move
	learnset 16, SEISMIC_TOSS
	learnset 19, REVERSAL ; Revenge → Sw/Sh move
	learnset 22, KNOCK_OFF
	learnset 25, MACH_PUNCH ; Vital Throw → egg move
	learnset 28, DRAIN_PUNCH ; Wake-Up Slap → new move
	learnset 31, OUTRAGE ; Dual Chop → new move
	learnset 34, CLOSE_COMBAT ; Submission → new move
	learnset 37, BULK_UP
	learnset 40, CROSS_CHOP
	learnset 43, SCARY_FACE
	learnset 46, DYNAMICPUNCH

	evos_attacks Machoke
	evo_data EVOLVE_TRADE, LINKING_CORD, MACHAMP
	evo_data EVOLVE_TRADE, BLACK_BELT, MACHAMP
	learnset 1, LOW_KICK
	learnset 1, LEER
	learnset 4, FOCUS_ENERGY
	learnset 7, KARATE_CHOP
	...
	learnset 22, KNOCK_OFF
	learnset 25, MACH_PUNCH ; Vital Throw → egg move
	learnset 29, DRAIN_PUNCH ; Wake-Up Slap → new move
	learnset 33, OUTRAGE ; Dual Chop → new move
	learnset 37, CLOSE_COMBAT ; Submission → new move
	learnset 41, BULK_UP
	learnset 45, CROSS_CHOP
	learnset 49, SCARY_FACE
	learnset 53, DYNAMICPUNCH
	...
	learnset 17, RAZOR_LEAF
	learnset 21, ACID
	learnset 25, KNOCK_OFF
	learnset 29, SWEET_KISS ; Sweet Scent → event move
	learnset 33, HEALINGLIGHT ; Gastro Acid → new move
	learnset 37, RAZOR_LEAF
	learnset 41, POISON_JAB
	learnset 45, SUCKER_PUNCH ; Slam → HGSS tutor move
	learnset 49, SWORDS_DANCE ; Wring Out → egg move
	...
	learnset 17, RAZOR_LEAF
	learnset 21, ACID
	learnset 26, KNOCK_OFF
	learnset 31, SWEET_KISS ; Sweet Scent → event move
	learnset 36, HEALINGLIGHT ; Gastro Acid → new move
	learnset 41, SEED_BOMB ; Razor Leaf → tutor move
	learnset 46, POISON_JAB
	learnset 51, SUCKER_PUNCH ; Slam → HGSS tutor move
	learnset 56, SWORDS_DANCE ; Wring Out → egg move
	...
	learnset 26, SUCKER_PUNCH ; Leaf Storm → prior move
	learnset 41, SEED_BOMB ; Leaf Blade → similar move
	...
	learnset 6, WATER_GUN ; Constrict → new move
	learnset 9, ACID
	learnset 12, TOXIC_SPIKES
	learnset 15, WATER_PULSE
	learnset 18, WRAP
	learnset 21, CONFUSE_RAY ; Acid Spray → event move
	learnset 24, BUBBLE_BEAM
	learnset 27, BARRIER
	learnset 30, POISON_JAB
	learnset 33, VENOSHOCK ; Brine → tutor move
	learnset 36, SCREECH
	learnset 39, HEX
	learnset 42, SLUDGE_BOMB ; Sludge Wave → TM move
	learnset 45, HYDRO_PUMP
	...
	learnset 27, BARRIER
	learnset 30, POISON_JAB
	learnset 35, VENOSHOCK ; Brine → tutor move
	learnset 40, SCREECH
	learnset 45, HEX
	learnset 50, SLUDGE_BOMB ; Sludge Wave → TM move
	...
	learnset 7, RAPID_SPIN ; Rock Polish → event move
	learnset 10, ROLLOUT
	learnset 13, MAGNITUDE
	learnset 16, ROCK_THROW
	learnset 19, RECOVER ; Smack Down → new move
	learnset 22, BULLDOZE
	learnset 25, ROCK_BLAST ; Self-Destruct → Rock Blast
	learnset 28, SANDSTORM ; Stealth Rock → TM move
	learnset 31, ROCK_SLIDE ; Rock Blast → TM move
	...
	evo_data EVOLVE_TRADE, HARD_STONE, GOLEM, PLAIN_FORM
	learnset 1, TACKLE
	learnset 1, DEFENSE_CURL
	learnset 4, MUD_SLAP ; Mud Sport → TM move
	learnset 7, RAPID_SPIN ; Rock Polish → event move
	...
	learnset 13, MAGNITUDE
	learnset 16, ROCK_THROW
	learnset 19, RECOVER ; Smack Down → HGSS tutor move
	learnset 22, BULLDOZE
	learnset 25, ROCK_BLAST ; Self-Destruct → Rock Blast
	learnset 30, SANDSTORM ; Stealth Rock → TM move
	learnset 35, ROCK_SLIDE ; Rock Blast → TM move
	learnset 40, EARTHQUAKE
	learnset 45, EXPLOSION
	learnset 50, DOUBLE_EDGE
	learnset 55, STONE_EDGE
	...
	evo_data EVOLVE_TRADE, HARD_STONE, GOLEM, ALOLAN_FORM
	learnset 1, TACKLE
	learnset 1, DEFENSE_CURL
	learnset 4, THUNDERSHOCK ; Charge → new move
	learnset 7, RAPID_SPIN ; Rock Polish → event move
	...
	learnset 4, LEER ; Tail Whip → similar move
	learnset 8, EMBER
	learnset 12, STOMP ; Flame Wheel → Stomp
	learnset 16, FLAME_CHARGE ; Stomp → Flame Charge
	learnset 20, LOW_KICK ; Flame Charge → event move
	learnset 24, FIRE_SPIN
	learnset 28, TAKE_DOWN
	learnset 32, DOUBLE_KICK ; Inferno → egg move
	learnset 36, AGILITY
	learnset 40, FIRE_BLAST
	learnset 44, EXTREMESPEED ; Bounce → new move
	learnset 48, FLARE_BLITZ
	...
	learnset 4, LEER ; Tail Whip → similar move
	learnset 8, CONFUSION
	learnset 12, DISARM_VOICE ; Fairy Wind → similar move
	learnset 16, STOMP
	learnset 20, HEALINGLIGHT ; Heal Pulse → similar move
	learnset 24, PSYBEAM
	learnset 28, TAKE_DOWN
	learnset 32, DAZZLINGLEAM
	learnset 36, AGILITY
	learnset 40, PSYCHIC_M
	learnset 44, EXTREMESPEED ; Bounce → new move
	learnset 48, MOONBLAST ; Healing Wish → new move
	...
	learnset 4, GROWL
	learnset 7, WATER_GUN
	learnset 10, SLEEP_TALK ; Yawn → egg move
	learnset 13, CONFUSION
	learnset 16, DISABLE
	learnset 19, WATER_PULSE
	learnset 22, HEADBUTT
	learnset 25, ZEN_HEADBUTT
	learnset 28, AMNESIA
	learnset 31, SURF
	learnset 34, RECOVER ; Slack Off → similar move
	learnset 37, PSYCHIC_M
	learnset 40, BELLY_DRUM ; Psych Up → egg move
	learnset 43, RAIN_DANCE
	learnset 46, SAFEGUARD ; Heal Pulse → egg move
	...
	learnset 34, RECOVER ; Slack Off → similar move
	learnset 37, PSYCHIC_M
	learnset 41, BELLY_DRUM ; Psych Up → egg move
	learnset 45, RAIN_DANCE
	learnset 49, SAFEGUARD ; Heal Pulse → egg move
	...
	learnset 1, TACKLE
	learnset 3, THUNDERSHOCK
	learnset 6, THUNDER_WAVE
	learnset 9, QUICK_ATTACK ; Magnet Bomb → TCG move
	learnset 12, LIGHT_SCREEN
	learnset 15, SONIC_BOOM
	learnset 18, SPARK
	learnset 21, SWIFT ; Mirror Shot → TM move
	learnset 24, SCREECH ; Metal Sound → Screech
	learnset 27, THUNDERBOLT ; Electro Ball → TM move
	learnset 30, FLASH_CANNON
	learnset 33, EXPLOSION ; Screech → TM move
	learnset 36, HIDDEN_POWER ; Discharge → TM move
	learnset 39, FORESIGHT ; Lock-On → similar move
	learnset 42, AGILITY ; Magnet Rise → event move
	learnset 45, THUNDER ; Gyro Ball → TM move
	...
	learnset 40, HIDDEN_POWER ; Discharge → TM move
	learnset 45, FORESIGHT ; Lock-On → similar move
	learnset 50, AGILITY ; Magnet Rise → event move
	learnset 55, THUNDER ; Gyro Ball → TM move
	...
	learnset 41, SEED_BOMB ; Feint → new move
	learnset 45, FALSE_SWIPE
	learnset 49, AIR_SLASH
	learnset 53, BRAVE_BIRD
	...
	learnset 5, FURY_STRIKES ; Fury Attack → similar move
if DEF(FAITHFUL)
	learnset 9, ROCK_SMASH
else
	learnset 9, REVERSAL ; Rock Smash → TM move
endc
	learnset 13, KNOCK_OFF
	...
	learnset 29, AGILITY
if DEF(FAITHFUL)
	learnset 33, NIGHT_SLASH ; Brick Break → egg move
else
	learnset 33, ROCK_SMASH ; Brick Break
endc
	learnset 37, HI_JUMP_KICK
	learnset 41, SEED_BOMB ; Feint → new move
	learnset 45, FALSE_SWIPE
	learnset 49, CLOSE_COMBAT
	learnset 53, BRAVE_BIRD
	...
	learnset 26, AGILITY
	learnset 29, HYPER_VOICE ; Uproar → similar move
	...
	learnset 10, ICY_WIND
	learnset 13, ENCORE
	learnset 16, ICE_SHARD
	learnset 19, AQUA_JET
	learnset 22, REST
	learnset 22, SLEEP_TALK ; Aqua Ring → TM move
	learnset 25, AURORA_BEAM
	learnset 28, BUBBLE_BEAM ; Brine → RBY TM move
	learnset 31, TAKE_DOWN
	learnset 34, ICICLE_SPEAR ; egg move
	learnset 37, PERISH_SONG ; Dive →  new move
	learnset 40, AQUA_TAIL
	...
	learnset 31, TAKE_DOWN
	learnset 34, ICICLE_SPEAR ; egg move
	learnset 40, PERISH_SONG ; Dive →  new move
	learnset 46, AQUA_TAIL
	learnset 52, ICE_BEAM
	learnset 58, SAFEGUARD
	learnset 64, HAIL
	...
	learnset 5, DEFENSE_CURL ; Harden → similar move
	learnset 9, MUD_SLAP
	learnset 13, DISABLE
	learnset 17, VENOSHOCK ; Sludge → tutor move
	learnset 21, MINIMIZE
	learnset 25, HAZE ; Mud Bomb → egg move
	learnset 29, FEINT_ATTACK ; Fling → new move
	learnset 33, SLUDGE_BOMB
	learnset 37, POISON_JAB ; Sludge Wave → TM move
	learnset 41, RECOVER ; Screech → Acid Armour → new move
	learnset 45, GUNK_SHOT
	learnset 49, SCREECH ; Acid Armour → Screech
	learnset 53, TOXIC ; Belch → TM move
	...
	learnset 17, VENOSHOCK ; Sludge → tutor move
	learnset 21, MINIMIZE
	learnset 25, HAZE ; Poison Fang → egg move
	learnset 29, FEINT_ATTACK ; Fling → new move
	learnset 33, KNOCK_OFF
	learnset 37, CRUNCH
	learnset 41, RECOVER ; Screech → Acid Armour → new move
	learnset 45, GUNK_SHOT
	learnset 49, SCREECH ; Acid Armour → Screech
	...
	learnset 33, SLUDGE_BOMB
	learnset 37, POISON_JAB ; Sludge Wave → TM move
	learnset 43, RECOVER ; Screech → Acid Armour → new move
	learnset 49, GUNK_SHOT
	learnset 55, SCREECH ; Acid Armour → Screech
	learnset 61, TOXIC ; Belch → TM move
	...
	learnset 16, PROTECT
	learnset 20, LEER
	learnset 24, BITE ; Ice Shard → new move
	...
	learnset 48, BARRIER ; Iron Defense → egg move
	learnset 52, ICE_BEAM
	...
	learnset 12, ICICLE_SPEAR ; Spikes → Icicle Spear
	learnset 32, PIN_MISSILE ; Sw/Sh TM move
	learnset 52, ICICLE_CRASH
	...
	learnset 1, LICK
	learnset 5, HYPNOSIS
	learnset 9, MEAN_LOOK
	learnset 13, ACID ; Payback → new move
	learnset 17, DISABLE ; Spite → egg move
	learnset 21, CURSE
	learnset 25, HEX
	learnset 29, NIGHT_SHADE
	learnset 33, PAIN_SPLIT ; Dark Pulse → HGSS tutor move
	learnset 37, SUCKER_PUNCH
	learnset 41, SHADOW_BALL
	learnset 45, DESTINY_BOND
	learnset 49, DREAM_EATER
	learnset 53, PSYCHIC_M

	evos_attacks Haunter
	evo_data EVOLVE_TRADE, LINKING_CORD, GENGAR
	evo_data EVOLVE_TRADE, SPELL_TAG, GENGAR
	...
	learnset 35, PAIN_SPLIT ; Dark Pulse → HGSS tutor move
	...
	learnset 1, LEER
	learnset 1, AQUA_JET ; Water Gun → new move
	learnset 4, DEFENSE_CURL ; Harden → similar move
	learnset 8, METAL_CLAW
	learnset 12, DIG ; Mud Shot → egg move
	learnset 16, PROTECT
	learnset 20, BUBBLE_BEAM
	learnset 24, STOMP
	learnset 28, REVERSAL ; Flail → similar move
	learnset 32, CRABHAMMER ; Razor Shell → Crabhammer
	learnset 36, BODY_SLAM ; Slam → TR move
	learnset 40, SWORDS_DANCE
	learnset 44, ANCIENTPOWER ; Crabhammer → Sw/Sh egg move
	learnset 48, X_SCISSOR ; Guillotine → TM move
	...
	learnset 24, STOMP
	learnset 28, REVERSAL ; Flail → similar move
	learnset 35, CRABHAMMER ; Razor Shell → Crabhammer
	learnset 42, BODY_SLAM ; Slam → TR move
	learnset 49, SWORDS_DANCE
	learnset 56, ANCIENTPOWER ; Crabhammer → Sw/Sh egg move
	learnset 63, X_SCISSOR ; Guillotine → TM move

	evos_attacks VoltorbPlain
	evo_data EVOLVE_LEVEL, 30, ELECTRODE
	learnset 1, TACKLE
	learnset 1, THUNDERSHOCK ; LGPE move
	learnset 3, SONIC_BOOM
	learnset 6, AGILITY ; Eerie Impulse → event move
	learnset 9, SPARK
	learnset 12, ROLLOUT
	learnset 15, SCREECH
	learnset 18, THUNDER_WAVE ; Charge Beam → TM move
	learnset 21, SWIFT
	learnset 24, THUNDERBOLT ; Electro Ball → TM move
	learnset 27, REFLECT ; Self-Destruct → TM move
	learnset 27, LIGHT_SCREEN
	learnset 30, THUNDER ; Magnet Rise → TM move
	learnset 33, WILD_CHARGE ; Discharge → TM move
	learnset 36, EXPLOSION
	learnset 39, GYRO_BALL
	learnset 42, MIRROR_COAT
	...
	learnset 27, LIGHT_SCREEN
	learnset 30, THUNDER ; Magnet Rise → TM move
	learnset 37, WILD_CHARGE ; Discharge → TM move
	learnset 44, EXPLOSION
	learnset 51, GYRO_BALL
	learnset 60, MIRROR_COAT
	...
	learnset 21, SWIFT
	learnset 24, THUNDERBOLT ; Electro Ball → TM move
	learnset 27, ENERGY_BALL
	learnset 30, SEED_BOMB
	learnset 33, THUNDER ; Discharge → TM move
	learnset 36, EXPLOSION
	learnset 39, GYRO_BALL
	learnset 42, GIGA_DRAIN ; Grassy Terrain → TM move
	...
	learnset 44, EXPLOSION
	learnset 51, GYRO_BALL
	learnset 60, GIGA_DRAIN ; Grassy Terrain → TM move
	...
	learnset 1, HYPNOSIS
	learnset 1, ABSORB ; Barrage → new move
	learnset 5, REFLECT
	learnset 9, LEECH_SEED
	learnset 13, CONFUSION
	learnset 17, MEGA_DRAIN
	learnset 21, STUN_SPORE
	learnset 21, POISONPOWDER
	learnset 21, SLEEP_POWDER
	learnset 25, SEED_BOMB
	learnset 29, HEALINGLIGHT
	learnset 33, GIGA_DRAIN
	learnset 37, EXTRASENSORY
	learnset 41, ANCIENTPOWER ; Uproar → egg move
	learnset 45, TRICK ; Worry Seed → new move
	learnset 49, SOLAR_BEAM

	evos_attacks ExeggutorPlain
	learnset 1, LOW_KICK ; HGSS tutor move
	learnset 1, DRAGON_RAGE
	learnset 1, DRAGON_BREATH
	...
	learnset 17, PSYBEAM ; Psyshock → LGPE move
	learnset 25, ZEN_HEADBUTT ; Egg Bomb → tutor move
	learnset 33, POWER_WHIP ; Wood Hammer → new move
	learnset 41, PETAL_DANCE ; Leaf Storm → new move
	learnset 49, EXPLOSION ; RBY TM move
	...
	learnset 25, ZEN_HEADBUTT ; Egg Bomb → tutor move
	learnset 33, POWER_WHIP ; Wood Hammer → new move
	learnset 41, OUTRAGE ; Leaf Storm → S/M TM move
	learnset 49, EXPLOSION ; RBY TM move
	...
	learnset 1, ROCK_SMASH ; evolution move
	learnset 4, DOUBLE_KICK
	learnset 8, LOW_KICK
	learnset 12, ENDURE
	learnset 16, KARATE_CHOP ; Revenge → new move
	learnset 20, FORESIGHT ; Wide Guard → Tyrogue move
	learnset 24. REVERSAL ; Blaze Kick → Reversal
	learnset 28, AGILITY ; Mind Reader → new move
	learnset 32, FOCUS_BLAST ; Mega Kick → TM move
	learnset 36, COUNTER ; Reversal → TM move
	learnset 40, AURA_SPHERE
	learnset 44, HI_JUMP_KICK
	learnset 48, CLOSE_COMBAT

	evos_attacks Hitmonchan
	learnset 1, DRAIN_PUNCH ; evolution move
	learnset 1, BULLET_PUNCH
	learnset 4, MACH_PUNCH
	learnset 8, LOW_KICK
	learnset 12, PROTECT ; Detect → similar move
	learnset 16, KARATE_CHOP ; Revenge → new move
	learnset 20, FORESIGHT ; Quick Guard → Tyrogue move
	learnset 24, FIRE_PUNCH
	learnset 24, THUNDERPUNCH
	learnset 24, ICE_PUNCH
	learnset 28, AGILITY
	learnset 32, DYNAMICPUNCH ; Mega Punch → TM move
	learnset 36, COUNTER
	learnset 40, AURA_SPHERE
	learnset 44, FOCUS_BLAST ; Focus Punch → TM move
	learnset 48, CLOSE_COMBAT
	...
	learnset 12, WILL_O_WISP ; Clear Smog → TM move
	learnset 16, ENDURE ; Assurance → TM move
	learnset 20, VENOSHOCK ; Sludge → tutor move
	learnset 24, HAZE
	learnset 28, GYRO_BALL ; Self-Destruct → Gyro Ball
	learnset 32, SLUDGE_BOMB
	learnset 36, PAIN_SPLIT ; Belch → HGSS tutor move
	learnset 40, TOXIC
	learnset 44, EXPLOSION
	learnset 48, FIRE_BLAST ; Memento → TM move
	learnset 52, DESTINY_BOND

	evos_attacks WeezingPlain
	learnset 1, DOUBLE_SLAP ; Double Hit → new move
	learnset 1, TACKLE
	learnset 4, ACID ; Smog → new move
	learnset 8, SMOKESCREEN
	learnset 12, WILL_O_WISP ; Clear Smog → TM move
	...
	learnset 28, GYRO_BALL ; Self-Destruct → Gyro Ball
	learnset 32, SLUDGE_BOMB
	learnset 38, PAIN_SPLIT ; Belch → HGSS tutor move
	learnset 44, TOXIC
	learnset 50, EXPLOSION
	learnset 56, FIRE_BLAST ; Memento → TM move
	learnset 62, DESTINY_BOND

	evos_attacks WeezingGalarian
	learnset 1, SAFEGUARD ; evolution move
	learnset 1, HAZE
	learnset 1, DAZZLINGLEAM ; Strange Steam → TR move
	learnset 1, DOUBLE_SLAP ; Double Hit → new move
	learnset 1, TACKLE
	learnset 4, ACID ; Smog → new move
	learnset 8, SMOKESCREEN
	...
	learnset 16, ENDURE ; Assurance → TM move
	learnset 20, VENOSHOCK ; Sludge → tutor move
	learnset 24, PLAY_ROUGH → Aromatherapy → TR move
	learnset 28, GYRO_BALL ; Self-Destruct → Gyro Ball
	learnset 32, SLUDGE_BOMB
	learnset 38, PAIN_SPLIT ; Belch → HGSS tutor move
	learnset 44, TOXIC
	learnset 50, EXPLOSION
	learnset 56, MOONBLAST ; Memento → new move
	learnset 62, DESTINY_BOND
	...
	learnset 58, MEGAHORN
	learnset 64, CLOSE_COMBAT ; Horn Drill → new move

	evos_attacks Chansey
	evo_data EVOLVE_HAPPINESS, TR_ANYTIME, BLISSEY
	learnset 1, GROWL
	learnset 1, MINIMIZE
	learnset 1, STRENGTH ; Pound → HM move
	learnset 1, DEFENSE_CURL
	learnset 4, LEER ; Tail Whip → similar move
	learnset 8, DOUBLE_SLAP
	learnset 12, FRESH_SNACK ; Life Dew → Soft-Boiled → similar move
	learnset 16, SING
	learnset 20, CHARM ; Fling → Happiny move
	learnset 24, TAKE_DOWN
	learnset 28, HEAL_BELL ; Heal Pulse → HGSS tutor move
	learnset 32, REFLECT ; Helping Hand → RBY TM move
	learnset 36, LIGHT_SCREEN
	learnset 40, HYPER_VOICE ; Double Edge → new move
	learnset 44, FRESH_SNACK ; Soft-Boiled → similar move
	learnset 48, DOUBLE_EDGE ; Last Resort → Double Edge
	learnset 52, SUBSTITUTE ; Healing Wish → TM move
	learnset 56, GIGA_IMPACT ; TM move
	...
	learnset 8, GROWTH
	learnset 12, VINE_WHIP
	learnset 16, MEGA_DRAIN
	learnset 20, POISONPOWDER
	learnset 24, HEALINGLIGHT ; AncientPower → Pt/HG/SS tutor move
	learnset 28, KNOCK_OFF
	learnset 32, GIGA_DRAIN
	learnset 36, STUN_SPORE
	learnset 40, ANCIENTPOWER ; Slam → AncientPower
	learnset 44, SWORDS_DANCE ; Tickle → TM move
	learnset 48, POWER_WHIP
	learnset 52, LEECH_SEED ; Ingrain → egg move
	learnset 56, BATON_PASS ; Grassy Terrain → new move

	evos_attacks Kangaskhan
	learnset 1, DIZZY_PUNCH ; Comet Punch → Dizzy Punch
	learnset 1, LEER
	learnset 4, GROWL
	learnset 8, LOW_KICK ; Fake Out → HGSS tutor move
	learnset 12, BITE
	learnset 16, HEADBUTT ; Bite → tutor move
	learnset 20, FOCUS_ENERGY
	learnset 24, RAGE
	learnset 28, SUCKER_PUNCH
	learnset 32, STOMP ; Double Hit → egg move
	learnset 36, CRUNCH
	learnset 40, ENDURE
	learnset 44, DOUBLE_EDGE
	learnset 48, OUTRAGE
	...
	learnset 1, LEER
	learnset 1, WATER_GUN
	learnset 4, SMOKESCREEN
	learnset 8, DRAGONBREATH ; Twister → DragonBreath
	learnset 12, FOCUS_ENERGY
	learnset 16, AQUA_JET ; DragonBreath → new move
	learnset 20, BUBBLE_BEAM
	learnset 24, AGILITY
	learnset 28, OUTRAGE ; Laser Focus → HGSS tutor move
	learnset 32, DRAGON_PULSE
	learnset 36, WATER_PULSE
	learnset 40, DRAGON_DANCE
	learnset 44, RAIN_DANCE
	learnset 48, HYDRO_PUMP
	...
	learnset 28, OUTRAGE ; Laser Focus → HGSS tutor move
	learnset 32, DRAGON_PULSE
	learnset 40, WATER_PULSE
	learnset 48, DRAGON_DANCE
	learnset 56, RAIN_DANCE
	...
	learnset 1, LEER ; Tail Whip → similar move
	learnset 5, SUPERSONIC
	learnset 9, WATER_PULSE
	learnset 13, HORN_ATTACK
	learnset 17, AGILITY
	learnset 21, HAZE ; Aqua Ring → egg move
	learnset 25, FURY_STRIKES ; Fury Attack → similar moves
	learnset 29, REVERSAL ; Flail → similar move
	learnset 33, WATERFALL
	learnset 37, KNOCK_OFF ; Soak → tutor move
	learnset 41, MEGAHORN
	learnset 45, BODY_SLAM ; Horn Drill → tutor move
	...
	learnset 29, REVERSAL ; Flail → similar move
	learnset 33, WATERFALL
	learnset 41, KNOCK_OFF ; Soak → tutor move
	learnset 49, MEGAHORN
	learnset 57, BODY_SLAM ; Horn Drill → tutor move
	...
	learnset 20, SWIFT
	learnset 24, PSYBEAM
	learnset 28, BUBBLE_BEAM 
	learnset 32, LIGHT_SCREEN
	learnset 36, POWER_GEM
	learnset 40, PSYCHIC_M
	learnset 44, SURF
	learnset 48, MINIMISE
	learnset 52, GYRO_BALL ; Cosmic Power → SMUSUM level-up move
	...
	learnset 16, AGILITY
	learnset 20, BUG_BITE ; Double Hit → new move
	learnset 24, SLASH
	learnset 28, FOCUS_ENERGY
	learnset 32, DOUBLE_TEAM
	learnset 36, AIR_SLASH
	learnset 40, X_SCISSOR
	learnset 44, NIGHT_SLASH
	...
	learnset 1, LICK
	learnset 3, DOUBLE_SLAP ; Pound → Double Slap
	learnset 6, ICY_WIND ; Powder Snow → TM move
	learnset 9, SING
	learnset 12, CONFUSION
	learnset 15, THIEF ; Covet → TM move
	learnset 18, AURORA_BEAM
	learnset 21, MEAN_LOOK
	learnset 24, PSYBEAM
	learnset 27, DRAININGKISS
	learnset 30, ICE_PUNCH
	learnset 36, NASTY_PLOT ; Mean Look → egg move
	learnset 42, PSYCHIC_M
	learnset 48, ICE_BEAM
	learnset 54, BLIZZARD
	...
	learnset 24, MACH_PUNCH
	learnset 27, LIGHT_SCREEN
	learnset 30, THUNDERPUNCH
	learnset 36, SCREECH
	learnset 42, CROSS_CHOP
	learnset 48, THUNDERBOLT
	learnset 54, THUNDER
	learnset 60, GIGA_IMPACT

	evos_attacks Magmar
	evo_data EVOLVE_TRADE, MAGMARIZER, MAGMORTAR
	learnset 1, ACID ; Smog → similar move
	learnset 3, LEER
	learnset 6, EMBER
	learnset 9, SMOKESCREEN
	learnset 12, FEINT_ATTACK
	learnset 15, LOW_KICK ; Clear Smog → HGSS tutor move
	learnset 18, FIRE_SPIN
	learnset 21, CONFUSE_RAY
	learnset 24, SUCKER_PUNCH
	learnset 27, FLAME_CHARGE
	learnset 30, FIRE_PUNCH
	learnset 36, SUNNY_DAY
	learnset 42, DARK_PULSE
	learnset 48, FLAMETHROWER
	learnset 54, FIRE_BLAST
	learnset 60, HYPER_BEAM

	evos_attacks Pinsir
	learnset 1, HEALINGLIGHT ; Wish → similar move
	learnset 1, DEFENSE_CURL ; Harden → similar move
	learnset 1, HEADBUTT
	learnset 4, FOCUS_ENERGY
	...
	learnset 20, ROCK_SMASH ; Storm Throw → TM move
	learnset 24, AERIAL_ACE ; Double Hit → new move
	learnset 28, FEINT_ATTACK ; Vital Throw → egg move
	learnset 32, X_SCISSOR
	learnset 36, THRASH ; Strength → SMUSUM level-up move
	learnset 40, SWORDS_DANCE
	learnset 44, OUTRAGE ; Submission → LGPE TM move
	learnset 48, MEGAHORN ; Guillotine → new move
	learnset 52, CLOSE_COMBAT ; Superpower → similar move
	...
	learnset 42, VENOSHOCK
	learnset 46, AIR_SLASH
	learnset 50, CRUNCH ; Quick Guard → new move
	...
	learnset 1, THUNDERSHOCK
	learnset 1, LEER ; Tail Whip → similar move
	learnset 4, THUNDER_WAVE ; Play Nice → Thunder Wave
	learnset 8, SWEET_KISS
	learnset 12, BODY_SLAM ; Nuzzle → similar move
	learnset 16, NASTY_PLOT
	learnset 20, CHARM
	learnset 24, PETAL_DANCE ; event move
...
endc
	...
	learnset 1, STUN_SPORE
	learnset 45, GROWTH ; Quiver Dance → Growth
	learnset 51, MOONBLAST ; Petal Blizzard → Gloom move
	learnset 57, PETAL_DANCE ; evolution move
	learnset 63, PLAY_ROUGH ; Leaf Storm → Sw/Sh move
...
; based on Gen V Chatot
	...
	learnset 12, PROTECT ; Detect → similar move
	learnset 16, KARATE_CHOP ; Revenge → new move
	learnset 20, FORESIGHT ; Quick Guard + Wide Guard → Tyrogue move
	learnset 24, SUCKER_PUNCH
	learnset 28, AGILITY
	learnset 32, DIG
	learnset 36, COUNTER
	learnset 40, AURA_SPHERE
	learnset 44, REVERSAL ; Endeavour → new move
	learnset 48, CLOSE_COMBAT
	...
	learnset 21, MEAN_LOOK
	learnset 24, PSYBEAM
	learnset 27, SWEET_KISS
	learnset 30, ICE_PUNCH
	learnset 33, NASTY_PLOT ; Mean Look → egg move
	...
	learnset 30, THUNDERPUNCH
	learnset 33, SCREECH
	learnset 36, CROSS_CHOP
	learnset 39, THUNDERBOLT
	learnset 42, THUNDER
	...
	learnset 1, MINIMIZE
	learnset 1, STRENGTH ; Pound → anime move
	learnset 1, SEISMIC_TOSS ; Copycat → egg move
	learnset 4, DEFENSE_CURL
	learnset 8, SWEET_KISS
	learnset 12, DISARM_VOICE
	...
	learnset 58, MEGAHORN
	learnset 64, CLOSE_COMBAT ; Horn Drill → new move
	learnset 70, GIGA_IMPACT ; Rock Wrecker → TM move
...
endc
	...
	learnset 35, SCREECH
	learnset 42, SLASH
	learnset 49, CRUNCH ; Metal Sound → TR move
	learnset 56, THRASH
	learnset 63, CLOSE_COMBAT ; TR move
...
endc
	...
	learnset 49, CLOSE_COMBAT
	learnset 53, BRAVE_BIRD
	learnset 57, GIGA_IMPACT ; Meteor Assault → similar move
	...
	learnset 1, ROCK_SLIDE ; evolution move
	learnset 1, AIR_SLASH
	learnset 1, WING_ATTACK
	learnset 1, QUICK_ATTACK
	learnset 1, LEER
	learnset 4, PURSUIT
	learnset 8, FALSE_SWIPE
	learnset 12, ROCK_THROW
	learnset 16, AGILITY
	learnset 20, BUG_BITE ; Double Hit → new move
	learnset 24, SLASH
	learnset 28, FOCUS_ENERGY
	learnset 32, DOUBLE_TEAM
	learnset 36, ROCK_BLAST ; Rock Slide → new move
	learnset 40, X_SCISSOR
	learnset 44, NIGHT_SLASH
	learnset 48, SWORDS_DANCE
